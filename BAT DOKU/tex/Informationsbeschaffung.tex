...
\tau  + \alpha + \varphi  = 1
\end{equation}
\myequations{Energieerhaltung der Wärmestrahlung}
...
\end{equation}
\myequations{Emissionsgrad bei thermischem Gleichgewicht}
...
\begin{figure}[!ht]
	...
	\begin{minipage}[b]{0.49\linewidth}
		...
		\captionof{figure}[Wäermebild eines\\Probanden]{Messresultate\\ mit Kopfbedeckung}
		\label{fig:mitHut}	
	\end{minipage}
\end{figure}
...
Die Emissionsgrade von Edelstahl schwanken zwischen 0,05 bis 0.82, je nachdem. wie das Material verarbeitet wurde. Auch Veredelungen durch Schleifen, Polieren oder Bürsten verändern die Oberflächenbeschaffenheit und haben eine Änderung des Emissionsgrad zur Folge. 
