...
Im Verlauf der Arbeit wurden mehrere Profile von Personenaufzügen erstellt. Diese dienten als Datensätze für das \ac{CNN}


\section{Symetrische Erweiterung}

Um die Datensätze zu vergrössern wurden die drei Profile erweitert. 
